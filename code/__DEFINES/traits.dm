...
#define TRAIT_INQUISITION "Member of the Grenzelholftian Inquisition"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_INQUISITION = span_info("I am a member of the Grenzelholftian Inquisition. I can easily identify others of my cadre at a glance."),
